...
pass_rsdw = items['data']['data']['dw_stage']
pass_rsdw_stg = items['data']['data']['rsdw_stg_stage']
s3_prefix = f'test_unload/{user_rs}/'
host_rs = 'dwstage.sjdk2s4khl77.us-west-2.redshift.amazonaws.com'
dbname_rs = 'dwrs'
port_rs = 5439

if user_rs == 'rsdw':
    password_rs = pass_rsdw
else:
    password_rs = pass_rsdw_stg 
